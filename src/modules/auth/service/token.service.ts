...
export class TokenService {
  ...
  private generateRefreshToken(payload: TokenPayload): string {
    const expiresIn = this.configService.getOrThrow<number>('JWT_REFRESH_TOKEN_EXPIRATION');
    const secret = this.configService.getOrThrow<string>('JWT_REFRESH_TOKEN_SECRET');
